...
#define BLOOD   COLOR(15,0,0)
#define GREEN   COLOR(0, 31, 0)
#define BLUE    COLOR(0,0,31)
#define YELLOW  COLOR(31,31,0)
#define CYAN    COLOR(0,31,31)
#define SKYBLUE COLOR(27,31,31)
#define COOLGREY COLOR(12,12,12)
#define MAGENTA COLOR(31,0,31)
#define PINK    COLOR(31,18,31)
#define APRICOT COLOR(31,18,14)
#define LAVENDER COLOR(22,13,31)
#define LIME    COLOR(9,31,7)
#define SEAFOAM COLOR(28,31,31)
#define BROWN   COLOR(19,10,0)
...
#define STRHEIGHT 8
#define STRWIDTH(length) (length)*6
...
void fillBackground(const u16 arr[]);
...
#include "pic/homepage.h"
#include "pic/winner.h"
#include "pic/loser.h"
